...
import { formatPrice, formatDateLong, initialsOf, phoneToTel, phoneToWhatsApp } from '@/lib/format';
        ...
        {supplier && (
          ...
          >
            <span className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-full bg-primary text-[13px] font-bold text-white">
